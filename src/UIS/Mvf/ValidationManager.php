...
class ValidationManager
{
    ...
    protected static $registeredValidators = [
        'int' => '\UIS\Mvf\ValidatorTypes\IntValidator',
        'digit' => '\UIS\Mvf\ValidatorTypes\DigitValidator',
        'float' => '\UIS\Mvf\ValidatorTypes\FloatValidator',
        'bool' => '\UIS\Mvf\ValidatorTypes\BoolValidator',
        'string' => '\UIS\Mvf\ValidatorTypes\StringValidator',
        'email' => '\UIS\Mvf\ValidatorTypes\EmailValidator',
        'password' => '\UIS\Mvf\ValidatorTypes\PasswordValidator',
        'date' => '\UIS\Mvf\ValidatorTypes\DateValidator',
        'url' => '\UIS\Mvf\ValidatorTypes\UrlValidator',
        'mvf' => '\UIS\Mvf\ValidatorTypes\MvfValidator',
        'array' => '\UIS\Mvf\ValidatorTypes\ArrayValidator',
        'enum' => '\UIS\Mvf\ValidatorTypes\EnumValidator',
        'phone' => '\UIS\Mvf\ValidatorTypes\PhoneValidator',
        'function' => '\UIS\Mvf\ValidatorTypes\FunctionValidator',
        'username' => '\UIS\Mvf\ValidatorTypes\UsernameValidator',
    ];

    protected static $registeredFilters = [
        'string' => '\UIS\Mvf\FilterTypes\StringFilter',
